package hiep.com.springboot.common.exception;
...
import hiep.com.springboot.common.error.ErrorResponse;
import hiep.com.springboot.common.error.FieldErrorResponse;
import hiep.com.springboot.common.error.InternalServerError;
import hiep.com.springboot.common.error.InvalidInputResponse;
import hiep.com.springboot.common.error.ResponseError;
...
public class ExceptionHandleAdvice {
    ...
    private void catchException(Exception exception) {
        ...
        if (Objects.nonNull(requestAttributes)) {
            requestAttributes.setAttribute("custom_exception_message", exception, RequestAttributes.SCOPE_REQUEST);
        }
    }
}
